...
const SimplexPaymentCheckout = ({ checkoutStatus }: CheckoutCompletedViewProps) => {
  const title = checkoutStatus.success ? 'Payment completed successfully' : 'Something went wrong';
  const description = checkoutStatus.success ? 'You can now close this page safely.' : 'Unfortunately your payment ended unsuccessfully.';
